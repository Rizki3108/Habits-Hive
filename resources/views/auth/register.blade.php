            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5 col-xxl-5 mx-auto">
                <div class="card rounded-4 mb-0 border-top border-4 border-primary border-gradient-1">
                    <div class="card-body p-5">
                        ...
                        <h4 class="fw-bold" style="text-align: center">Register</h4>
                        ...
                        <div class="form-body my-4">
                            <form action="{{ route('register') }}"method="POST" class="row g-3" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-grd-info text-light">Register</button>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="text-start">
                                        <p class="mb-0">Sudah punya akun? <a href="{{ route('login') }}">Masuk
                                                disini</a></p>
                                    </div>
                                </div>
                            </form>
