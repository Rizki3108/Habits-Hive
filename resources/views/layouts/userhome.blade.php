                ...
                <div class="row">
                  ...
                  <div class="col-12 col-sm-5">
                    <div class="welcome-back-img pt-4">
                       <img src="{{asset('userhome/assets/images/gallery/welcome-back-3.png')}}" height="180" alt="">
                    </div>
                  </div>
                </div><!--end row-->
              </div>
                ...
                <div class="d-flex flex-column justify-content-between gap-4">
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{asset('userhome/assets/images/apps/17.png')}}" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{asset('userhome/assets/images/apps/18.png')}}" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{asset('userhome/assets/images/apps/19.png')}}" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{asset('userhome/assets/images/apps/20.png')}}" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{asset('userhome/assets/images/apps/05.png')}}" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{asset('userhome/assets/images/apps/08.png')}}" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{asset('userhome/assets/images/apps/07.png')}}" width="32" alt="">
